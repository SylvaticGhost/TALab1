    ...
    <main className="flex flex-row gap-7 justify-center p-10">
      ...
      <div id="random_box " className='flex-auto w-30'>
        ...
        <form className="max-w-sm mx-auto mt-10">
          ...
          <label htmlFor="number-input" className="block mb-2 text-sm font-medium text-gray-900 ">Count of rows:</label>
          ...
          <button type="button" onClick={() => {generateMatrix(rows,columns)}}
      ...
      <div className="output flex justify-center pt-20">
        <button type="button"
                className="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2" onClick={() => {
                  setMatrix('');
                  setRows(4)
                  setColumns(4)
        }}>Reset
            ...
            <button
              className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-cyan-500 to-blue-500 group-hover:from-cyan-500 group-hover:to-blue-500 hover:text-white focus:ring-4 focus:outline-none focus:ring-cyan-200 " onClick={() => {
                sendData()
            }}>
              <span
