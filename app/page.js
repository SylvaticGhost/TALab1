        ...
        <>
            <main className="flex flex-row gap-7 justify-center p-10">
                ...
                <div id="random_box " className='flex-auto w-30'>
                    ...
                    <form className="max-w-sm mx-auto mt-10">
                     ...
                     focus:border-blue-500 block w-100 p-2.5 " min={1}
                        ...
                        <label htmlFor="number-input" className="block mt-3 mb-2 text-sm font-medium text-gray-900 ">Count
                            of
                            columns:</label>
                        <input type="number" id="number-input" aria-describedby="helper-text-explanation"
                ...
                <div id="drag_n" className='flex-auto w-30'>
                    ...
                    <div className="w-[300px] relative border-2 border-gray-300 border-dashed rounded-lg p-6"
                         id="dropzone">
                        ...
                        <div className="text-center">
                            <img className="mx-auto h-12 w-12" src="https://www.svgrepo.com/show/389177/file-input.svg"
                                 alt=""/>
